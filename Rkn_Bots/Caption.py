...
async def start_cmd(bot, message):
    ...
    await message.reply_photo(photo=Rkn_Bots.RKN_PIC,
        ...
        reply_markup=types.InlineKeyboardMarkup([[
            types.InlineKeyboardButton('Main Channel', url='https://t.me/WarriorUnitsBots'),
            types.InlineKeyboardButton('Anime Channel', url='https://t.me/Warrior_Units')
            ],[
            types.InlineKeyboardButton('🔥 But Source Code 50rs Only🔥', url='https://t.me/oo7jatji')
    ]]))
